...
export default function AdminLayout({ children }) {
  ...
  const getNavigation = () => {
    ...
    if (role === 'shopkeeper') {
      return [
        { name: 'Dashboard', href: '/shopkeeper/dashboard', icon: 'dashboard' },
        { name: 'Place Order', href: '/shopkeeper/orders', icon: 'orders' },
      ];
    } else if (role === 'salesman') {
      return [
        { name: 'Orders', href: '/salesman/orders', icon: 'orders' },
        { name: 'Place Order', href: '/salesman/place-order', icon: 'orders' },
        { name: 'Recovery', href: '/salesman/recovery', icon: 'recovery' },
      ];
    } else if (role === 'admin') {
      return [
          ...
          <div className="relative flex-1 flex flex-col max-w-xs w-full bg-white">
            ...
            <div className="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
              <div className="flex-shrink-0 flex items-center px-4">
                <h1 className="text-xl font-bold text-gray-900">Ideal Nimko Admin</h1>
              </div>
            ...
            <div className="flex-shrink-0 flex border-t border-gray-200 p-4">
              <div className="flex items-center">
                <div>
                  <div className="text-base font-medium text-gray-800">{admin?.username}</div>
                  <div className="text-sm font-medium text-gray-500">{admin?.role}</div>
                </div>
                <button
                  onClick={logout}
                  className="ml-3 text-sm text-red-600 hover:text-red-900"
                >
                  Logout
                </button>
              </div>
