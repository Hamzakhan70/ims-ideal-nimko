...
export default function SettingsPage() {
    ...
    // Update filters when search/role changes
    useEffect(() => {
    ...
    }, [selectedRole, handleFilterChange]);
            ...
            <div className="border-b border-gray-200 mb-8">
                <nav className="-mb-px flex space-x-8">
                    <button onClick={
                        ...
                        className={
                            `py-2 px-1 border-b-2 font-medium text-sm ${
                                activeTab === 'users' ? 'border-yellow-500 text-yellow-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'
                            }`
                    }>
                        User Management
                    </button>
                    <button onClick={
                        ...
                        className={
                            `py-2 px-1 border-b-2 font-medium text-sm ${
                                activeTab === 'cities' ? 'border-yellow-500 text-yellow-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'
                            }`
                    }>
                        Cities Management
                    </button>
                    <button onClick={
                        ...
                        className={
                            `py-2 px-1 border-b-2 font-medium text-sm ${
                                activeTab === 'system' ? 'border-yellow-500 text-yellow-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'
                            }`
                    }>
                        System Settings
                    </button>
                            ...
                            <form onSubmit={handleSubmit}
                                ...
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 mb-2">
                                        Password {
                                        editingUser && <span className="text-gray-500 text-sm">(Leave blank to keep current)</span>
                                    } </label>
                                    <input type="password"
                                        required={
                                            !editingUser
                            ...
                            <form onSubmit={handleCitySubmit}
                                ...
                                <div>
                                    ...
                                    <input type="text" required
                                        ...
                                        onChange={
                                            (e) => setCityForm({name: e.target.value.trim()})
                                        }
